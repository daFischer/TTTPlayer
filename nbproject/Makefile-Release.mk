...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tttplayer: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/tttplayer ${OBJECTFILES} ${LDLIBSOPTIONS}
...
${OBJECTDIR}/AudioInterface.o: AudioInterface.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AudioInterface.o AudioInterface.cpp

${OBJECTDIR}/AudioJS.o: AudioJS.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/AudioJS.o AudioJS.cpp

${OBJECTDIR}/ColorConverter.o: ColorConverter.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/ColorConverter.o ColorConverter.cpp
...
${OBJECTDIR}/Messages/HighlightAnnotation.o: Messages/HighlightAnnotation.cpp 
	${MKDIR} -p ${OBJECTDIR}/Messages
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Messages/HighlightAnnotation.o Messages/HighlightAnnotation.cpp
...
${OBJECTDIR}/SizedArray.o: SizedArray.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/SizedArray.o SizedArray.cpp
